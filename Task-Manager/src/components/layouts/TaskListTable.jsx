        ...
        <table className="min-w-full">
            <thead>
                <tr className="text-left">
                    <th className="py-3 px-4 text-gray-800 font-medium text-[13px]">Nombre</th>
                    <th className="py-3 px-4 text-gray-800 font-medium text-[13px]">Estado</th>
                    <th className="py-3 px-4 text-gray-800 font-medium text-[13px]">Prioridad</th>
                    <th className="py-3 px-4 text-gray-800 font-medium text-[13px]">Creado el</th>
                </tr>
            </thead>
            <tbody>
                {tableData.map((task) => (
